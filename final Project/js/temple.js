const dataURL = 'json/temple.json';
...
fetch(dataURL)
    ...
    .then((jsonObject) => {
        ...
        temples.forEach(displaytemplesInGrid);
        temples.forEach(displaytemplesInList);
    });

function displaytemplesInList(temples) {
...
function displaytemplesInGrid(temples) {
    ...
    image.setAttribute("alt", `Logo of ${temples.name}`);
